" AZ modified: remove underscore, set Type color to Statement
" Apr 9, 2014
"
...
" AZ: in the Type I removed underline and changed green --> cyan like in the Statement
exe "hi Type           start=[m[4;32m    stop=[m[32m   ctermfg=".s:cyan."    ".s:ulbg."                guifg=cyan                            term=none".s:underline.s:bold." cterm=none".s:bold"               gui=none".s:bold
