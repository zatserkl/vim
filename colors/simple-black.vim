...
let g:colors_name="simple-black"
...
hi Identifier cterm=Bold  gui=Bold      guifg=Black              guibg=NONE              ctermfg=Black
hi Function   cterm=Bold  gui=Bold      guifg=Black              guibg=NONE              ctermfg=Black
hi Statement  cterm=Bold  gui=Bold      guifg=Black              guibg=NONE              ctermfg=Black
hi Type       cterm=Bold  gui=Bold      guifg=Black              guibg=NONE              ctermfg=Black
